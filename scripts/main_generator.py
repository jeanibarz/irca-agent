...
from generators.trace_generator import GuidedTraceGenerator
from utils import shuffle_json_functions
...
def main():
    ...
    config = {
        ...
        "model_name_or_path": "/workspace/models/finetuned_models/Mistral-7B-Instruct-v0.1_irca_agent_v5-5-3.gguf/checkpoint-82",
        "min_funcs": 1,
        "max_funcs": 20,
    ...
    # n = 40
    for i in range(start, len(src_ds.records)):
        ...
        available_functions = shuffle_json_functions(
            available_functions=src_ds.records[i].fields["available_functions"]
        )
