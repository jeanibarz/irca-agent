...
1. **Re-read GEMINI.md** - Re-ground yourself in project guidelines and behavioral rules
...
```
Phase 1: Extract module      → Commit code → Checkpoint (GEMINI.md, MEMORY.md, EXPERIENCES.md)
...
Per GEMINI.md documentation standards:
...
Project Skills and Preferences
